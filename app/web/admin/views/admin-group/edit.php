...
<div class="box-primary">
    <div class="box-header"></div>
        ...
        <div class="form-group field-admingroup-adg_status">
            ...
            <div class="col-lg-4">
            <?php echo Html::checkbox('AdminGroup[adg_status]', AdminGroupService::statusIsOn($model->adg_status), ['id' => 'admingroup-adg_status']); ?></div>
...
$(document).ready(function(){
    var _adg_id = "<?php echo $model->adg_id; ?>";
    /* 初始化 */
    ...
    $('button[adm="submit"]').on('click', function(){
        ...
        var _data = {'id': _adg_id, 'AdminGroup[adg_name]': _adg_name, 'AdminGroup[adg_status]': _adg_status};
