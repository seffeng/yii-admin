...
<div class="box-primary">
    <div class="box-header"></div>
        ...
        <div class="form-group field-menunav-mn_status">
            ...
            <div class="col-lg-4">
            <?php echo Html::checkbox('MenuNav[mn_status]', TRUE, ['id' => 'menunav-mn_status']); ?></div>
            <div class="col-lg-6"><div class="help-block"></div></div>
        </div>
...
$(document).ready(function(){
    ...
    $('button[adm="submit"]').on('click', function(){
        ...
        var _data = {'MenuNav[mn_name]': _mn_name, 'MenuNav[mn_url]': _mn_url, 'MenuNav[mn_icon]': _mn_icon, 'MenuNav[mn_type]': _mn_type, 'MenuNav[mn_pid]': _mn_pid, 'MenuNav[mn_status]': _mn_status};
