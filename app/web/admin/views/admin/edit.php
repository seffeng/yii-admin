...
$(document).ready(function(){
    var _ad_id = "<?php echo $model->ad_id; ?>";
    /* 初始化 */
    ...
    $('button[adm="submit"]').on('click', function(){
        ...
        var _data = {'id': _ad_id, 'Admin[ad_username]': _ad_username, 'Admin[ad_password]': _ad_password, 'Admin[ad_status]': _ad_status, 'Admin[adg_id]': _adg_id, 'Admin[pv_ids]': _pv_ids, 'Admin[pvg_ids]': _pvg_ids, 'AdminInfo[ai_name]': _ai_name, 'AdminInfo[ai_phone]': _ai_phone, 'AdminInfo[ai_email]': _ai_email};
