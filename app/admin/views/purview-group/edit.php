...
<div class="box-primary">
    ...
    <div id="add-form" class="form-horizontal box-body">
        <div class="form-group field-pvg_name">
            <label class="col-lg-2 control-label" for="pvg_name">权限组名：</label>
            <div class="col-lg-4"><input type="text" id="pvg_name" class="form-control" name="PurviewGroup[pvg_name]" value="<?php echo $model->pvg_name; ?>" ></div>
        ...
        <div class="form-group field-pvg_status">
            ...
            <div class="col-lg-4">
            <?php echo Html::checkbox('PurviewGroup[pvg_status]', $model->pvg_status == PurviewGroup::STATUS_NORMAL ? TRUE : FALSE, ['id' => 'pvg_status']); ?></div>
            <div class="col-lg-6"><div class="help-block"></div></div>
        </div>
...
$(document).ready(function(){
    ...
    $('button[adm="submit"]').on('click', function(){
        ...
        var _data = {id: _id, 'PurviewGroup[pvg_name]': _pvg_name, 'PurviewGroup[pvg_status]': _pvg_status, 'PurviewGroup[pv_ids]': _pv_ids};
