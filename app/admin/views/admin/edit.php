...
<div class="box-primary">
    ...
    <div id="add-form" class="form-horizontal box-body">
        ...
        <div class="form-group field-admin-adg_id">
            ...
            <div class="col-lg-4">
                <?php echo Html::dropDownList('Admin[adg_id]', $model->adg_id, $admin_group, ['class' => 'form-control', 'id' => 'admin-adg_id']); ?>
            </div>
            <div class="col-lg-6"><div class="help-block"></div></div>
        </div>
        <div class="form-group field-admin-ad_status">
            ...
            <div class="col-lg-4">
            <?php echo Html::checkbox('Admin[ad_status]', $model->ad_status == Admin::STATUS_NORMAL ? TRUE : FALSE, ['id' => 'admin-ad_status']); ?></div>
            <div class="col-lg-6"><div class="help-block"></div></div>
        </div>
...
$(document).ready(function(){
    ...
    $('button[adm="submit"]').on('click', function(){
        ...
        var _data = {id: _id, 'Admin[ad_username]': _ad_username, 'Admin[ad_password]': _ad_password, 'Admin[ad_status]': _ad_status, 'Admin[adg_id]': _adg_id, 'Admin[pv_ids]': _pv_ids, 'Admin[pvg_ids]': _pvg_ids, 'AdminInfo[ai_name]': _ai_name, 'AdminInfo[ai_nickname]': _ai_nickname, 'AdminInfo[ai_phone]': _ai_phone, 'AdminInfo[ai_email]': _ai_email};
