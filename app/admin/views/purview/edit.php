...
<div class="box-primary">
    ...
    <div id="add-form" class="form-horizontal box-body">
        <div class="form-group field-pv_name">
            <label class="col-lg-2 control-label" for="pv_name">组名：</label>
            <div class="col-lg-4"><input type="text" id="pv_name" class="form-control" name="Purview[pv_name]" value="<?php echo $model->pv_name; ?>" ></div>
        ...
        <div class="form-group field-pv_key">
            ...
            <div class="col-lg-4"><input type="text" id="pv_key" class="form-control" name="Purview[pv_key]" value="<?php echo $model->pv_key; ?>"></div>
            <div class="col-lg-6"><div class="help-block"></div></div>
        </div>
        <div class="form-group field-pv_status">
            <label class="col-lg-2 control-label" for="pv_status">状态：</label>
            <div class="col-lg-4">
            <?php echo Html::checkbox('Purview[pv_status]', $model->pv_status == Purview::STATUS_NORMAL ? TRUE : FALSE, ['id' => 'pv_status']); ?></div>
            <div class="col-lg-6"><div class="help-block"></div></div>
        </div>
...
$(document).ready(function(){
    ...
    $('button[adm="submit"]').on('click', function(){
        ...
        var _data = {id: _id, 'Purview[pv_name]': _pv_name, 'Purview[pv_key]': _pv_key, 'Purview[pv_status]': _pv_status};
