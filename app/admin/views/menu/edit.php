...
<div class="box-primary">
    ...
    <div id="add-form" class="form-horizontal box-body">
        <div class="form-group field-menu-mn_name">
            ...
            <div class="col-lg-4"><input type="text" id="menu-mn_name" class="form-control" name="Menu[mn_name]" value="<?php echo $model->mn_name; ?>"></div>
        ...
        <div class="form-group field-menu-mn_url">
            ...
            <div class="col-lg-4"><input type="text" id="menu-mn_url" class="form-control" name="Menu[mn_url]" value="<?php echo $model->mn_url; ?>"></div>
            <div class="col-lg-6"><div class="help-block"></div></div>
        </div>
        <div class="form-group field-menu-mn_icon">
            <label class="col-lg-2 control-label" for="menu-mn_icon">菜单图标：</label>
            <div class="col-lg-4"><input type="text" id="menu-mn_icon" class="form-control" name="Menu[mn_icon]" value="<?php echo $model->mn_icon; ?>"></div>
            <div class="col-lg-6"><div class="help-block"></div></div>
        </div>
        <div class="form-group field-menu-mn_type">
            <label class="col-lg-2 control-label" for="menu-mn_type">菜单类型：</label>
            <div class="col-lg-4">
            <?php echo Html::dropDownList('Menu[mn_type]', $model->mn_type, $mn_types, ['class' => 'form-control', 'id' => 'menu-mn_type']); ?>
            </div>
            <div class="col-lg-6"><div class="help-block"></div></div>
        </div>
        ...
        <div class="form-group field-menu-mn_status">
            ...
            <div class="col-lg-4">
            <?php echo Html::checkbox('Menu[mn_status]', $model->mn_status == Menu::STATUS_NORMAL ? TRUE : FALSE, ['id' => 'menu-mn_status']); ?></div>
            <div class="col-lg-6"><div class="help-block"></div></div>
        </div>
...
$(document).ready(function(){
    ...
    $('button[adm="submit"]').on('click', function(){
        ...
        var _data = {'id': _id, 'Menu[mn_name]': _mn_name, 'Menu[mn_url]': _mn_url, 'Menu[mn_icon]': _mn_icon, 'Menu[mn_type]': _mn_type, 'Menu[mn_pid]': _mn_pid, 'Menu[mn_status]': _mn_status};
